...
extern int m_rename(struct Client* cptr, struct Client* sptr, int parc, char* parv[]);
...
extern int m_tagmsg_typing(struct Client*, struct Client*, int, char*[]);
extern int m_tagmsg_done(struct Client*, struct Client*, int, char*[]);
extern int m_tagmsg_paused(struct Client*, struct Client*, int, char*[]);
...
extern int ms_knock(struct Client*, struct Client*, int, char* []);
